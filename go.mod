...
replace (
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.24.7-rc.0
...
replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.24.4

replace k8s.io/sample-controller => k8s.io/sample-controller v0.24.4
